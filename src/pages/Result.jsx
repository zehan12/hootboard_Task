...
const Result = () => {
    return (
        <Fragment>
            <div class="w-64 cursor-pointer flex flex-col justify-center items-center text-center border-none bg-white">
                <div class="text-md text-left border-2 border-b-black w-full font-bold  text-gray-900 p-4">
                    <span>---</span>
                    <span class="uppercase">Today</span> </div>
                ...
                <div class="text-5xl font-bold text-gray-900 mb-6">13º C</div>

                <p class="text-gray-700 mb-2">Partly cloud</p>


                <div class="flex justify-between w-full border-2 border-red-700 m-0">
                    <div class="flex items-center justify-center w-full text-gray-700 border-2 border-black">
                    ...
                    <div class="flex justify-center items-center w-full text-gray-700 border-2 border-black">
